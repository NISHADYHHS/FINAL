    ...
    with app.app_context():
        ...
        if not User.query.first():
            db.session.add_all([
                ...
                User(username="Joker", password="5", role= "admin")
            ])
            db.session.add_all([
                Course(name="Math 101", capacity=30, start_time=time(16, 0), end_time=time(17, 0), nofstudents= 0, teacher= "Amon Hepworth"),  # 4 PM to 5 PM
                Course(name="History 202", capacity=25, start_time=time(15, 0), end_time=time(16, 0), nofstudents= 0, teacher= "Stephanian Haik"),  # 3 PM to 4 PM
                Course(name="Math 133", capacity=30, start_time=time(8, 0), end_time=time(9, 0), nofstudents= 0, teacher= "Renato Farias"),  # 4 PM to 5 PM
                Course(name="CSE 234", capacity=25, start_time=time(10, 0), end_time=time(11, 0), nofstudents= 0, teacher= "Borna Hlousek"),  # 3 PM to 4 PM
                Course(name="EE 111", capacity=30, start_time=time(16, 0), end_time=time(18, 0), nofstudents= 0, teacher= "Juan Meza"),  # 4 PM to 5 PM
                Course(name="Philosophy 233", capacity=25, start_time=time(15, 0), end_time=time(17, 0), nofstudents= 0, teacher= "Jill Jim"),  # 3 PM to 4 PM
            ])
            db.session.add_all([
